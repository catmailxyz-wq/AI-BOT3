...
@DiscordBot.event
async def on_interaction_global(bot: DiscordBot, interaction: discord.Interaction):
    """Handle all button/select interactions globally."""
    pass


# Monkeypatch to add global interaction handling to DiscordBot
_original_on_interaction = None
